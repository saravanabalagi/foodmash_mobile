export default (state = {
    ...
    switch(action.type) {
        ...
        case "FETCH_DISH_VARIANT_FULFILLED": newState.dishVariants = updateDishVariants(state.dishVariants, action); newState.error = null; newState.inProgress = false; break;
